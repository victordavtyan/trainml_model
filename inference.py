...
#   generator = torch.Generator("cuda").manual_seed(args.seed)
    ...
    prompt1="redshift style, painted portrait of {args.token} a paladin,colorfull,masculine, mature, handsome,silver,gold and blue, fantasy armor, intricate, elegant, highly detailed, digital painting,artstation, concept art, smooth, sharp focus, illustration, gaston bussiere, alphonse mucha"
    prompt2="Portrait of {args.token}, charliebo artstyle, viking warrior,medieval armor, fantasy,elegant,sharp eyes focus,handsome,epic composition,highly detailed, intricate, digital painting, trending on artstation, concept art, smooth, dark, gloomy, realistic, illustration, 8k, 4k, dramatic lighting, d&d"
    prompt3="{args.token} as a powerful mysterious wizard, casting lightning magic,(blue lightning,flash),detailed clothing, digital painting, fantasy, Surrealist, by Stanley Artgerm Lau and Alphonse Mucha, artstation, highly detailed, sharp focus, stunningly beautiful, dystopian, iridescent gold, cinematic lighting, dark"
    prompt4="beautiful satanic male,necromancer blood king,portrait of {args.token},ritualistic,oil painting, angular features,magician cloak,in style of Greg Rutkowski,blood drops,red and black, illustration, 8k, 4k,dramatic lighting,((dark and gloomy universe)),smoke and shadow, night"
    prompt5="Digital painting of a beautiful man android,{args.token}, cyborg, robotic parts,(sci-fi costume),camo battle armor, studio soft light, rim light, vibrant details, luxurious cyberpunk, (lace), anatomical, facial muscles,ultra detailed, cable electric wires, microchip, elegant, beautiful background, octane render,style of Stephen Hickman, 8k"
    prompt6="poster of a god, portrait of {args.token} with hyperdimensional totem implants,neon arnaments, bio luminescent, water, plasma, creature,turquoise and violet, artwork by tooth wu and wlop and android jones and greg rutkowski"
