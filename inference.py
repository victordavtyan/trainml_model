...
#   generator = torch.Generator("cuda").manual_seed(args.seed)
    ...
    prompt1=f"<lora:Elixir:1>, redshift style, painted portrait of {args.token} a paladin,colorfull,masculine, mature, handsome,silver,gold and blue, fantasy armor, intricate, elegant, highly detailed, digital painting,artstation, concept art, smooth, sharp focus, illustration, gaston bussiere, alphonse mucha"
    prompt2=f"<lora:Elixir:1>, Portrait of {args.token}, charliebo artstyle, viking warrior,medieval armor, fantasy,elegant,sharp eyes focus,handsome,epic composition,highly detailed, intricate, digital painting, trending on artstation, concept art, smooth, dark, gloomy, realistic, illustration, 8k, 4k, dramatic lighting, d&d"
    prompt3=f"<lora:Elixir:1>, {args.token} as a powerful mysterious wizard, casting lightning magic,(blue lightning,flash),detailed clothing, digital painting, fantasy, Surrealist, by Stanley Artgerm Lau and Alphonse Mucha, artstation, highly detailed, sharp focus, stunningly beautiful, dystopian, iridescent gold, cinematic lighting, dark"
    prompt4=f"<lora:Elixir:1>, beautiful satanic male,necromancer blood king,portrait of {args.token},ritualistic,oil painting, angular features,magician cloak,in style of Greg Rutkowski,blood drops,red and black, illustration, 8k, 4k,dramatic lighting,((dark and gloomy universe)),smoke and shadow, night"
    prompt5=f"<lora:Elixir:1>, Digital painting of a beautiful man android,{args.token}, cyborg, robotic parts,(sci-fi costume),camo battle armor, studio soft light, rim light, vibrant details, luxurious cyberpunk, (lace), anatomical, facial muscles,ultra detailed, cable electric wires, microchip, elegant, beautiful background, octane render,style of Stephen Hickman"
    prompt6=f"<lora:Elixir:1>, poster of a god, portrait of {args.token} with hyperdimensional totem implants,neon arnaments, bio luminescent, water, plasma, creature,turquoise and violet, artwork by tooth wu and wlop and android jones and greg rutkowski"
    prompt7 =f"<lora:Elixir:1>, {args.token}, ((tarot card with intricate detailed frame around the outside)) | side profile of cyberpunk head with large moon in background| cyberpunk | styled in Art Nouveau | insanely detailed | embellishments | high definition | concept art | digital art | vibrant"
    prompt8 =f"<lora:Elixir:1>, {args.token}, comic book panel, lineart illustration ,  sharp eyes focus , redhead,((man in plate armor )), ((ultra realistic detailed eyes)), intricate eye details, cute smile, sweaty , ultra skin texture, ((ultra skin details)),intricate details, (in dark sci-fi space ship)"
